...
INSERT INTO Sach(TenSach, IDSach, MoTa, Gia, NhaXB, TacGia, NgayXB,SoLuong,NgayUp)
...
Đây là cuốn sách hoàn hảo cho bất kỳ người chạy bộ nào – dù là lính mới hay vận động viên marathon dày dạn – mong muốn cải thiện thành tích và có thêm niềm vui trong chạy bộ.',188000,N'Thế Giới','Meb Keflezighi','2019',7,'20190101'),
...
Gió thổi nhẹ. Ánh sáng phản chiếu từ mặt hồ trong buổi sớm mai làm tinh thần ta tỉnh táo lạ thường. Đột nhiên, chim mòng biển bay vút lên cao tựa như quăng vào không trung sự tự do thầm kín.',139000,N'Lao Động - Xã Hội','Beop Sang','2019',0,'20190101'),
...
Những tình tiết bất ngờ trong Cáp treo tình yêu sẽ khiến bạn phải bật cười và tự hỏi điều gì tiếp theo có thể xảy ra.',89000,N'Hà Nội','Keigo Higashino','2019',0,'20190101'),
...
Hay bí mật được hé lộ?',45000,N'Nhà Xuất Bản Phụ Nữ',N'Thiên Xuyên','2019',8,'20190101'),
...
Đan xen giữa quá khứ và hiện tại, tác phẩm đầu tay của Josh Malerman là một kiệt tác khiến bạn không ngừng hồi hộp cho đến khi khép lại cuốn sách.',98000,N'Hà Nội','Josh Malerman','2019',2,'20190101'),
...
“Cuộc khủng hoảng sinh thái đang lấp ló, mối đe dọa của các loại vũ khí hủy diệt hàng loạt [...] và sự trỗi dậy của các công nghệ đột phá mới” là những nỗi lo không của riêng ai; và Harari sẽ đồng hành cùng bạn trên con đường bóc tách từng vấn đề một cách thấu đáo.',209000 ,N'Thế Giới',N'Yuval Noah Harari','2019',4,'20190101'),
...
Blog của cô, Island Bell, viết về ẩm thực, du lịch và lối sống',109000,N'Hà Nội','Mikumo Gakuto','2019',4,'20190101'),
...
Tập ba với những cuộc phiêu của cô thiếu nữ và chàng kiện thủ, đối đầu với những cuồng vọng của con người xoay quanh những cuốn sách ác ma với sức mạnh phi thường bắt đầu.',149000,N'Thế Giới','Erin Niimi Longhurst','2019',1,'20190101'),
...
Chính là bí mật về người đàn ông Milan ! Có cô gái nào mà không quan tâm đến một người đàn ông Milan hào hoa, quyến rũ cơ chứ ? Nhưng đừng dễ dàng để mắc vào lưới của anh chàng hào hoa này đấy nhé ! 2 tác giả của chúng ta sẽ bật mí cho bạn biết những điều bạn chưa bao giờ được nghe về người đàn ông Milan !',129000,N'Thế Giới','Alice Rosati','2019',1,'20191112'),
...
',75000,N'Hội Văn Học','J. D. Salinger','09-2017',0,'20190101'),
...
',125000,N'Lao Động',N'Cố Mạn','07-2016',0,'20190101'),

(N'CHO TÔI XIN 1 VÉ ĐI TUỔI THƠ','S019',N'Truyện Cho tôi xin một vé đi tuổi thơ là sáng tác mới nhất của nhà văn Nguyễn Nhật Ánh. Nhà văn mời người đọc lên chuyến tàu quay ngược trở lại thăm tuổi thơ và tình bạn dễ thương của 4 bạn nhỏ. Những trò chơi dễ thương thời bé, tính cách thật thà, thẳng thắn một cách thông minh và dại dột, những ước mơ tự do trong lòng… khiến cuốn sách có thể làm các bậc phụ huynh lo lắng rồi thở phào. Không chỉ thích hợp với người đọc trẻ, cuốn sách còn có thể hấp dẫn và thực sự có ích cho người lớn trong quan hệ với con mình.',80000,N'NXB Trẻ',N'Nguyễn Nhật Ánh','11-2008',4,'20190101'),
...
',80000,N'NXB Hồng Đức','Kate DiCamillo','06-2019',3,'20190101'),
...
',90000,N'Nhà Xuất Bản Văn Học','Ichikawa Takuji','08-2018',8,'20191112'),
...
',120000,N'Nhà Xuất Bản Văn Học','Harper Lee','12-2018',6,'20190101'),
...
Câu chuyện ly kỳ và hấp dẫn ngay từ lúc bắt đầu đến khi ta gấp sách lại sẽ khiến độc giả nhỏ tuổi thích thú, say mê. Nó xứng đáng là cuốn sách gối đầu giường cho những ai say mê khám phá. Sách được in màu, trình bày đẹp, có kèm tranh minh họa sinh động, nằm trong bộ truyện ngắn 12 cuốn Văn học kinh điển dành cho thiếu nhi.',89000,N'Nhà Xuất Bản Văn Học','Jules Verne','08-2015',0,'20190101'),
...
… Bởi sự trong sáng của một tình cảm, bởi cái kết thúc buồn, rất buồn khi xuyên suốt câu chuyện vẫn là những điều vui, buồn lẫn lộn …  ',110000,N'NXB Trẻ',N'Nguyễn Nhật Ánh','07-2019',2,'20190101'),
...
Văn phong của Hemingway giản dị, trong sáng, ẩn chứa nhiều triết lý sâu sắc về tự nhiên và con người. chất liệu sống ngồn ngộn, độc thoại nội tâm, tình huống biến hóa, căng thẳng, đa nghĩa và đa thanh.',45000,N'NXB Văn Bản','Ernest Hemingway','2018',2,'20190101'),
...
Điều này cũng không thật sự lạ, vì, đã trở thành quy luật, những câu trả lời thì qua đi, còn câu hỏi thì ở lại.',85000,N'Nhà Xuất Bản Hội Văn Học','Haruki Murakami','03-2018',1,'20190101'),
...
VALUES ('S001',1,1),
('S002',2,2)
 //sách đc mua nhiều nhất 
SELECT  * FROM Sach WHERE IDSach IN (
  SELECT TOP(4) IDSach FROM SachDaMua 
  GROUP BY IDSach
  ORDER BY COUNT(SoLuong) DESC 
)
// sách đc up mới nhất 
  SELECT TOP(6)  * FROM Sach  
  ORDER BY NgayUp DESC

// tìm truyện theo thể loại 
  SELECT * FROM Sach RIGHT JOIN LoaiSach AS ls
  ON Sach.IDSach = ls.IDSach
   WHERE ls.IDLoai = (
    SELECT IDLoai FROM TheLoai WHERE  TheLoai.Name = N'Truyện Tranh'  
  )

// tìm thể loại truyện 
SELECT Name FROM TheLoai

SELECT * FROM Sach WHERE IDSach IN ( SELECT TOP(4) IDSach FROM SachDaMua GROUP BY IDSach ORDER BY COUNT(SoLuong) DESC )
SELECT TOP(6) * FROM Sach ORDER BY NgayUp DESC
